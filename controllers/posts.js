...
export const getPosts = (req, res)=>{
  ...
  const sql = "SELECT p.* FROM Posts as p JOIN users AS u ON (u.id = p.userId) LEFT JOIN Follow AS f ON (p.userId = f.followedId ) WHERE  f.followBack='yes' OR  f.followerId = ? OR p.userId = ?;"; // 
